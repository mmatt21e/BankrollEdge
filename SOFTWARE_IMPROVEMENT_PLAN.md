...
| B9 | `docs: make the repo front door truthful…` | ✅ Done | T-24, T-25. APK untracked + `dist/` ignored; git history not rewritten. **Owner decision:** no GitHub Release for the APK — the product is the PWA; historical APK builds remain retrievable from git history if ever needed |
